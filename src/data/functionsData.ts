...
export const functionsData: FunctionItem[] = [
  // 1. SUM & AVERAGE (Combined)
  {
    ...
    rows: [
      ['রাহিম আহমেদ', 85, 78, 92, 88, '=SUM(B2:E2)', '=ROUND(AVERAGE(B2:E2), 2)'],
      ['সাদিয়া ইসলাম', 90, 84, 88, 95, '=SUM(B3:E3)', '=ROUND(AVERAGE(B3:E3), 2)'],
      ['তানভীর হাসান', 65, 70, 72, 68, '=SUM(B4:E4)', '=ROUND(AVERAGE(B4:E4), 2)'],
      ['নুসরাত জাহান', 78, 82, 80, 85, '=SUM(B5:E5)', '=ROUND(AVERAGE(B5:E5), 2)'],
      ['মাহমুদুল হাসান', 92, 88, 95, 90, '=SUM(B6:E6)', '=ROUND(AVERAGE(B6:E6), 2)'],
      ['ফারহানা হক', 55, 60, 58, 62, '=SUM(B7:E7)', '=ROUND(AVERAGE(B7:E7), 2)'],
      ['আরিফুর রহমান', 80, 75, 85, 78, '=SUM(B8:E8)', '=ROUND(AVERAGE(B8:E8), 2)'],
      ['মেহেরিন সুলতানা', 88, 91, 84, 89, '=SUM(B9:E9)', '=ROUND(AVERAGE(B9:E9), 2)'],
      ['জাহিদ করিম', 72, 68, 75, 70, '=SUM(B10:E10)', '=ROUND(AVERAGE(B10:E10), 2)'],
      ['তাসনিম আক্তার', 95, 92, 98, 94, '=SUM(B11:E11)', '=ROUND(AVERAGE(B11:E11), 2)']
    ]
  },
  ...
  // 6. IF, NESTED IF & IFS (Combined)
  {
    ...
    rows: [
      ['রাকিবুল হাসান', 85, 78, 92, '=ROUND(AVERAGE(B2:D2), 2)', '=IF(E2>=40, "Pass", "Fail")', '=IF(E2>=80, "A", IF(E2>=70, "B", IF(E2>=60, "C", "F")))', '=IFS(E2>=80, "Outstanding", E2>=70, "Very Good", E2>=60, "Good", TRUE, "Needs Help")'],
      ['সানজিদা আহমেদ', 90, 84, 88, '=ROUND(AVERAGE(B3:D3), 2)', '=IF(E3>=40, "Pass", "Fail")', '=IF(E3>=80, "A", IF(E3>=70, "B", IF(E3>=60, "C", "F")))', '=IFS(E3>=80, "Outstanding", E3>=70, "Very Good", E3>=60, "Good", TRUE, "Needs Help")'],
      ['তানিম ইকবাল', 65, 70, 72, '=ROUND(AVERAGE(B4:D4), 2)', '=IF(E4>=40, "Pass", "Fail")', '=IF(E4>=80, "A", IF(E4>=70, "B", IF(E4>=60, "C", "F")))', '=IFS(E4>=80, "Outstanding", E4>=70, "Very Good", E4>=60, "Good", TRUE, "Needs Help")'],
      ['মুমতাহিনা হক', 78, 82, 80, '=ROUND(AVERAGE(B5:D5), 2)', '=IF(E5>=40, "Pass", "Fail")', '=IF(E5>=80, "A", IF(E5>=70, "B", IF(E5>=60, "C", "F")))', '=IFS(E5>=80, "Outstanding", E5>=70, "Very Good", E5>=60, "Good", TRUE, "Needs Help")'],
      ['নাজমুল সাকিব', 35, 42, 38, '=ROUND(AVERAGE(B6:D6), 2)', '=IF(E6>=40, "Pass", "Fail")', '=IF(E6>=80, "A", IF(E6>=70, "B", IF(E6>=60, "C", "F")))', '=IFS(E6>=80, "Outstanding", E6>=70, "Very Good", E6>=60, "Good", TRUE, "Needs Help")'],
      ['সুমাইয়া ফারহানা', 58, 62, 60, '=ROUND(AVERAGE(B7:D7), 2)', '=IF(E7>=40, "Pass", "Fail")', '=IF(E7>=80, "A", IF(E7>=70, "B", IF(E7>=60, "C", "F")))', '=IFS(E7>=80, "Outstanding", E7>=70, "Very Good", E7>=60, "Good", TRUE, "Needs Help")'],
      ['ফাহিম মোর্শেদ', 74, 76, 75, '=ROUND(AVERAGE(B8:D8), 2)', '=IF(E8>=40, "Pass", "Fail")', '=IF(E8>=80, "A", IF(E8>=70, "B", IF(E8>=60, "C", "F")))', '=IFS(E8>=80, "Outstanding", E8>=70, "Very Good", E8>=60, "Good", TRUE, "Needs Help")'],
      ['তাসফিয়া ইসলাম', 88, 92, 86, '=ROUND(AVERAGE(B9:D9), 2)', '=IF(E9>=40, "Pass", "Fail")', '=IF(E9>=80, "A", IF(E9>=70, "B", IF(E9>=60, "C", "F")))', '=IFS(E9>=80, "Outstanding", E9>=70, "Very Good", E9>=60, "Good", TRUE, "Needs Help")'],
      ['আব্দুল্লাহ আলিম', 62, 68, 65, '=ROUND(AVERAGE(B10:D10), 2)', '=IF(E10>=40, "Pass", "Fail")', '=IF(E10>=80, "A", IF(E10>=70, "B", IF(E10>=60, "C", "F")))', '=IFS(E10>=80, "Outstanding", E10>=70, "Very Good", E10>=60, "Good", TRUE, "Needs Help")'],
      ['রুবাইয়া খানম', 92, 95, 94, '=ROUND(AVERAGE(B11:D11), 2)', '=IF(E11>=40, "Pass", "Fail")', '=IF(E11>=80, "A", IF(E11>=70, "B", IF(E11>=60, "C", "F")))', '=IFS(E11>=80, "Outstanding", E11>=70, "Very Good", E11>=60, "Good", TRUE, "Needs Help")']
    ]
  },
  ...
  // 12. PMT & PV (Combined)
  {
    ...
    tokens: [
      { text: '=ROUND(PMT(', class: 'c-fn' },
      { text: 'B2/12, C2*12, -D2', class: 'c-p1' },
      { text: '), 2)', class: 'c-fn' },
      { text: ' | ', class: 'c-fn' },
      { text: '=ROUND(PV(', class: 'c-fn' },
    ...
    rows: [
      ['হাউজিং লোন (Home Loan)', 0.09, 15, 3000000, '=ROUND(PMT(B2/12, C2*12, -D2), 2)', '=ROUND(PV(B2/12, C2*12, -E2), 2)'],
      ['অটোমোবাইল লোন (Car Loan)', 0.11, 5, 1200000, '=ROUND(PMT(B3/12, C3*12, -D3), 2)', '=ROUND(PV(B3/12, C3*12, -E3), 2)'],
      ['শিক্ষা ঋণ (Education Loan)', 0.08, 7, 600000, '=ROUND(PMT(B4/12, C4*12, -D4), 2)', '=ROUND(PV(B4/12, C4*12, -E4), 2)'],
      ['পার্সোনাল লোন (Personal Loan)', 0.12, 3, 300000, '=ROUND(PMT(B5/12, C5*12, -D5), 2)', '=ROUND(PV(B5/12, C5*12, -E5), 2)'],
      ['এসএমই বিজনেস লোন (SME)', 0.10, 5, 2000000, '=ROUND(PMT(B6/12, C6*12, -D6), 2)', '=ROUND(PV(B6/12, C6*12, -E6), 2)'],
      ['কৃষি ও খামার ঋণ (Agri Loan)', 0.06, 3, 500000, '=ROUND(PMT(B7/12, C7*12, -D7), 2)', '=ROUND(PV(B7/12, C7*12, -E7), 2)'],
      ['বাণিজ্যিক স্পেস লোন', 0.115, 10, 4500000, '=ROUND(PMT(B8/12, C8*12, -D8), 2)', '=ROUND(PV(B8/12, C8*12, -E8), 2)'],
      ['মেডিকেল ইমার্জেন্সি লোন', 0.095, 2, 250000, '=ROUND(PMT(B9/12, C9*12, -D9), 2)', '=ROUND(PV(B9/12, C9*12, -E9), 2)']
    ]
  },
  ...
  // 13. FV & RATE (Combined)
  {
    ...
    tokens: [
      { text: '=ROUND(FV(', class: 'c-fn' },
      { text: 'B2/12, C2*12, -D2, -E2', class: 'c-p1' },
      { text: '), 2)', class: 'c-fn' },
      { text: ' | ', class: 'c-fn' },
      { text: '=ROUND(RATE(', class: 'c-fn' },
      { text: 'C2*12, -D2, -E2, F2', class: 'c-p2' },
      { text: ')*12*100, 2) & "%"', class: 'c-fn' }
    ],
    params: [
    ...
    rows: [
      ['ডিপিএস সঞ্চয় স্কিম ১', 0.08, 5, 2500, 0, '=ROUND(FV(B2/12, C2*12, -D2, -E2), 2)', '=ROUND(RATE(C2*12, -D2, -E2, F2)*12*100, 2) & "%"'],
      ['ডিপিএস সঞ্চয় স্কিম ২', 0.085, 10, 5000, 0, '=ROUND(FV(B3/12, C3*12, -D3, -E3), 2)', '=ROUND(RATE(C3*12, -D3, -E3, F3)*12*100, 2) & "%"'],
      ['প্রিমিয়াম রিটায়ারমেন্ট ফান্ড', 0.09, 15, 8000, 50000, '=ROUND(FV(B4/12, C4*12, -D4, -E4), 2)', '=ROUND(RATE(C4*12, -D4, -E4, F4)*12*100, 2) & "%"'],
      ['শিশু শিক্ষা সেভিংস প্ল্যান', 0.075, 7, 3000, 20000, '=ROUND(FV(B5/12, C5*12, -D5, -E5), 2)', '=ROUND(RATE(C5*12, -D5, -E5, F5)*12*100, 2) & "%"'],
      ['গোল্ডেন ফিউচার স্কিম', 0.10, 12, 10000, 100000, '=ROUND(FV(B6/12, C6*12, -D6, -E6), 2)', '=ROUND(RATE(C6*12, -D6, -E6, F6)*12*100, 2) & "%"'],
      ['শর্ট টার্ম গ্রোথ ফান্ড', 0.07, 3, 4000, 10000, '=ROUND(FV(B7/12, C7*12, -D7, -E7), 2)', '=ROUND(RATE(C7*12, -D7, -E7, F7)*12*100, 2) & "%"'],
      ['বিশেষ দ্বিগুণ বৃদ্ধি স্কিম', 0.095, 8, 6000, 30000, '=ROUND(FV(B8/12, C8*12, -D8, -E8), 2)', '=ROUND(RATE(C8*12, -D8, -E8, F8)*12*100, 2) & "%"'],
      ['পেনশনার্স সেভিংস বন্ড', 0.105, 5, 0, 500000, '=ROUND(FV(B9/12, C9*12, -D9, -E9), 2)', '=ROUND(RATE(C9*12, -D9, -E9, F9)*12*100, 2) & "%"']
    ]
  },
  ...
  // 14. PRACTICE LAB: FINANCIAL BANKING ANALYSIS (Question 1: AB Bank, Savings, Education Loan Combined)
  {
    ...
    tokens: [
      { text: '=ROUND(RATE(C2*12, -D2, -E2, F2)*12*100, 2) & "%"', class: 'c-p1' },
      { text: ' | ', class: 'c-fn' },
      { text: '=ROUND(FV(B4/12, C4*12, -D4, -E4), 2)', class: 'c-p2' },
      { text: ' | ', class: 'c-fn' },
      { text: '=ROUND(PMT(B5/12, C5*12, -E5), 2)', class: 'c-p3' }
    ],
    params: [
    ...
    rows: [
      ['১(ক) এবি ব্যাংক মিলিয়নেয়ার সুদের হার', '', 12, 3400, 0, 1000000, '=ROUND(RATE(C2*12, -D2, -E2, F2)*12*100, 2) & "%"'],
      ['১(ক) এবি ব্যাংক ৫ বছর পর রিটার্ন', 0.1069, 5, 3400, 0, '', '=ROUND(FV(B3/12, C3*12, -D3, -E3), 2)'],
      ['১(খ) সেভিংস অ্যাকাউন্টে ১০ বছরের রিটার্ন', 0.10, 10, 10000, 100000, '', '=ROUND(FV(B4/12, C4*12, -D4, -E4), 2)'],
      ['১(গ) সিটি ব্যাংক এডুকেশন লোন ইএমআই', 0.11, 10, '', 425000, 0, '=ROUND(PMT(B5/12, C5*12, -E5), 2)'],
      ['১(গ) এডুকেশন লোনে ১০ বছরে মোট পরিশোধ', 0.11, 10, '', 425000, 0, '=ROUND(PMT(B5/12, C5*12, -E5)*120, 2)']
    ]
  },
  ...
  // 15. PRACTICE LAB: DPS & INVESTMENT COMPARISON (Question 2: Comparison Suite)
  {
    ...
    tokens: [
      { text: '=ROUND(RATE(E2*12, -D2, -B2, F2)*12*100, 2) & "%"', class: 'c-p1' },
      { text: ' | ', class: 'c-fn' },
      { text: '=ROUND(RATE(E3*52, -D3, -B3, F3)*52*100, 2) & "%"', class: 'c-p2' },
      { text: ' | ', class: 'c-fn' },
      { text: '=ROUND(FV(C4/12, E4*12, -D4, -B4), 2)', class: 'c-p3' },
      { text: ' | ', class: 'c-fn' },
      { text: '=ROUND(FV(C5/52, E5*52, -D5, -B5), 2)', class: 'c-p4' }
    ],
    params: [
    ...
    rows: [
      ['২(ক) স্কিম ১: মাসিক ডিপিএস', 15000, '', 2000, 12, 500000, '=ROUND(RATE(E2*12, -D2, -B2, F2)*12*100, 2) & "%"', 'সুদের হার ৭.৪৫%'],
      ['২(ক) স্কিম ২: সাপ্তাহিক ডিপিএস', 0, '', 375, 5, 500000, '=ROUND(RATE(E3*52, -D3, -B3, F3)*52*100, 2) & "%"', 'বিজয়ী: ৫৪.৩৬% সুদ (অধিক লাভজনক)'],
      ['২(খ) স্কিম ১: মাসিক ইনভেস্টমেন্ট', 0, 0.1075, 1200, 12, '', '=ROUND(FV(C4/12, E4*12, -D4, -B4), 2)', '১২ বছরে ৩,৪৯,৮৮৩.৮৬ টাকা রিটার্ন'],
      ['২(খ) স্কিম ২: সাপ্তাহিক ইনভেস্টমেন্ট', 30000, 0.115, 250, 12, '', '=ROUND(FV(C5/52, E5*52, -D5, -B5), 2)', 'বিজয়ী: ৪,৫৪,৬৭৪.৫৮ টাকা (১.০৪ লাখ বেশি)']
    ]
  },
  ...
  // 17. AVERAGEIF & AVERAGEIFS (Combined)
  {
    ...
    tokens: [
      { text: '=ROUND(AVERAGEIF(', class: 'c-fn' },
      { text: 'B$2:B$11, "আইটি", D$2:D$11', class: 'c-p1' },
      { text: '), 2)', class: 'c-fn' },
      { text: ' | ', class: 'c-fn' },
      { text: '=ROUND(AVERAGEIFS(', class: 'c-fn' },
    ...
    rows: [
      ['মাহবুবুর রহমান', 'আইটি', 4, 55000, '=ROUND(AVERAGEIF(B$2:B$11, "আইটি", D$2:D$11), 2)', '=ROUND(AVERAGEIFS(D$2:D$11, B$2:B$11, "আইটি", C$2:C$11, ">=3"), 2)'],
      ['সানজিদা সুলতানা', 'এইচআর', 3, 42000, '=ROUND(AVERAGEIF(B$2:B$11, "এইচআর", D$2:D$11), 2)', '=ROUND(AVERAGEIFS(D$2:D$11, B$2:B$11, "এইচআর", C$2:C$11, ">=3"), 2)'],
      ['নাজমুল হক', 'আইটি', 2, 38000, '=ROUND(AVERAGEIF(B$2:B$11, "আইটি", D$2:D$11), 2)', '=ROUND(AVERAGEIFS(D$2:D$11, B$2:B$11, "আইটি", C$2:C$11, ">=3"), 2)'],
      ['নুসরাত জাহান', 'মার্কেটিং', 5, 48000, '=ROUND(AVERAGEIF(B$2:B$11, "মার্কেটিং", D$2:D$11), 2)', '=ROUND(AVERAGEIFS(D$2:D$11, B$2:B$11, "মার্কেটিং", C$2:C$11, ">=3"), 2)'],
      ['আরিফুল ইসলাম', 'আইটি', 6, 75000, '=ROUND(AVERAGEIF(B$2:B$11, "আইটি", D$2:D$11), 2)', '=ROUND(AVERAGEIFS(D$2:D$11, B$2:B$11, "আইটি", C$2:C$11, ">=3"), 2)'],
      ['ফারহানা ইসলাম', 'এইচআর', 1, 32000, '=ROUND(AVERAGEIF(B$2:B$11, "এইচআর", D$2:D$11), 2)', '=ROUND(AVERAGEIFS(D$2:D$11, B$2:B$11, "এইচআর", C$2:C$11, ">=3"), 2)'],
      ['তানভীর হাসান', 'মার্কেটিং', 2, 35000, '=ROUND(AVERAGEIF(B$2:B$11, "মার্কেটিং", D$2:D$11), 2)', '=ROUND(AVERAGEIFS(D$2:D$11, B$2:B$11, "মার্কেটিং", C$2:C$11, ">=3"), 2)'],
      ['শামীমা আক্তার', 'আইটি', 3, 50000, '=ROUND(AVERAGEIF(B$2:B$11, "আইটি", D$2:D$11), 2)', '=ROUND(AVERAGEIFS(D$2:D$11, B$2:B$11, "আইটি", C$2:C$11, ">=3"), 2)'],
      ['কামরুল ইসলাম', 'এইচআর', 4, 45000, '=ROUND(AVERAGEIF(B$2:B$11, "এইচআর", D$2:D$11), 2)', '=ROUND(AVERAGEIFS(D$2:D$11, B$2:B$11, "এইচআর", C$2:C$11, ">=3"), 2)'],
      ['আয়েশা সিদ্দিকা', 'আইটি', 5, 68000, '=ROUND(AVERAGEIF(B$2:B$11, "আইটি", D$2:D$11), 2)', '=ROUND(AVERAGEIFS(D$2:D$11, B$2:B$11, "আইটি", C$2:C$11, ">=3"), 2)']
    ]
  },
