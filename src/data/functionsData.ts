...
export const functionsData: FunctionItem[] = [
  ...
  // 16. SUMIFS & COUNTIFS (Combined)
  {
    ...
    desc: 'একাধিক শর্ত সাপেক্ষে যোগ (SUMIFS) এবং একাধিক শর্ত সাপেক্ষে গণনা (COUNTIFS)। একই টেবিলে ১০ম শ্রেণির বিজ্ঞান বিভাগের শিক্ষার্থীদের মোট গণিত নম্বর ও মোট শিক্ষার্থী সংখ্যা নির্ণয়।',
    tokens: [
      { text: '=SUMIFS(', class: 'c-fn' },
      { text: 'E$2:E$11, B$2:B$11, "১০ম", C$2:C$11, "বিজ্ঞান"', class: 'c-p1' },
      { text: ')', class: 'c-fn' },
      { text: ' | ', class: 'c-fn' },
      { text: '=COUNTIFS(', class: 'c-fn' },
      { text: 'B$2:B$11, "১০ম", C$2:C$11, "বিজ্ঞান"', class: 'c-p2' },
      { text: ')', class: 'c-fn' }
    ],
    params: [
      { name: 'SUMIFS (১০ম বিজ্ঞান মোট নম্বর)', meaning: '১০ম শ্রেণি এবং "বিজ্ঞান" বিভাগের শিক্ষার্থীদের গণিতের মোট নম্বর যোগফল নির্ণয় করে।', class: 'c-p1' },
      { name: 'COUNTIFS (১০ম বিজ্ঞান শিক্ষার্থী)', meaning: '১০ম শ্রেণি এবং "বিজ্ঞান" বিভাগে মোট কতজন শিক্ষার্থী আছে তা গণনা করে।', class: 'c-p2' },
      { name: 'B$2:B$11 ও C$2:C$11', meaning: 'যথাক্রমে শ্রেণি (Class) এবং বিভাগ (Group) ফিল্টার করার সেল রেঞ্জ।', class: 'c-p3' }
    ],
    activeCell: 'F2',
    cols: ['A', 'B', 'C', 'D', 'E', 'F', 'G'],
    colWidths: ['140px', '90px', '105px', '100px', '105px', '180px', '180px'],
    headers: ['শিক্ষার্থীর নাম', 'শ্রেণি', 'বিভাগ', 'উপস্থিতি (%)', 'গণিত নম্বর', '১০ম বিজ্ঞান মোট নম্বর (SUMIFS)', '১০ম বিজ্ঞান শিক্ষার্থী (COUNTIFS)'],
    rows: [
      ['রাকিবুল হাসান', '১০ম', 'বিজ্ঞান', 95, 88, '=SUMIFS(E$2:E$11, B$2:B$11, "১০ম", C$2:C$11, "বিজ্ঞান")', '=COUNTIFS(B$2:B$11, "১০ম", C$2:C$11, "বিজ্ঞান")'],
      ['সানজিদা আক্তার', '১০ম', 'ব্যবসায়', 88, 76, '=SUMIFS(E$2:E$11, B$2:B$11, "১০ম", C$2:C$11, "ব্যবসায়")', '=COUNTIFS(B$2:B$11, "১০ম", C$2:C$11, "ব্যবসায়")'],
      ['তানিম ইকবাল', '৯ম', 'বিজ্ঞান', 92, 92, '=SUMIFS(E$2:E$11, B$2:B$11, "৯ম", C$2:C$11, "বিজ্ঞান")', '=COUNTIFS(B$2:B$11, "৯ম", C$2:C$11, "বিজ্ঞান")'],
      ['মুমতাহিনা হক', '১০ম', 'বিজ্ঞান', 96, 85, '=SUMIFS(E$2:E$11, B$2:B$11, "১০ম", C$2:C$11, "বিজ্ঞান")', '=COUNTIFS(B$2:B$11, "১০ম", C$2:C$11, "বিজ্ঞান")'],
      ['নাজমুল সাকিব', '১০ম', 'মানবিক', 82, 68, '=SUMIFS(E$2:E$11, B$2:B$11, "১০ম", C$2:C$11, "মানবিক")', '=COUNTIFS(B$2:B$11, "১০ম", C$2:C$11, "মানবিক")'],
      ['সুমাইয়া খানম', '৯ম', 'বিজ্ঞান', 90, 82, '=SUMIFS(E$2:E$11, B$2:B$11, "৯ম", C$2:C$11, "বিজ্ঞান")', '=COUNTIFS(B$2:B$11, "৯ম", C$2:C$11, "বিজ্ঞান")'],
      ['ফাহিম মোর্শেদ', '১০ম', 'ব্যবসায়', 85, 74, '=SUMIFS(E$2:E$11, B$2:B$11, "১০ম", C$2:C$11, "ব্যবসায়")', '=COUNTIFS(B$2:B$11, "১০ম", C$2:C$11, "ব্যবসায়")'],
      ['তাসফিয়া ইসলাম', '১০ম', 'বিজ্ঞান', 98, 95, '=SUMIFS(E$2:E$11, B$2:B$11, "১০ম", C$2:C$11, "বিজ্ঞান")', '=COUNTIFS(B$2:B$11, "১০ম", C$2:C$11, "বিজ্ঞান")'],
      ['আব্দুল্লাহ আলিম', '৯ম', 'ব্যবসায়', 84, 70, '=SUMIFS(E$2:E$11, B$2:B$11, "৯ম", C$2:C$11, "ব্যবসায়")', '=COUNTIFS(B$2:B$11, "৯ম", C$2:C$11, "ব্যবসায়")'],
      ['রুবাইয়া রহমান', '১০ম', 'বিজ্ঞান', 94, 90, '=SUMIFS(E$2:E$11, B$2:B$11, "১০ম", C$2:C$11, "বিজ্ঞান")', '=COUNTIFS(B$2:B$11, "১০ম", C$2:C$11, "বিজ্ঞান")']
    ]
  },
